...
/**
 * Миграция оставшихся владельцев с сохранением vetais_id
 */
...
async function main() {
  console.log('╔════════════════════════════════════════════════════════════╗');
  console.log('║   МИГРАЦИЯ ОСТАВШИХСЯ ВЛАДЕЛЬЦЕВ ИЗ VETAIS                ║');
  console.log('╚════════════════════════════════════════════════════════════╝\n');
  ...
  try {
    ...
    const vetaisResult = await vetaisDb.query(`
      ...
      ORDER BY kod_kado
    `);
    console.log(`✅ Всего владельцев в Vetais: ${vetaisResult.rows.length}\n`);
    ...
    console.log(`⚠️  Пропущено (нет телефона): ${skippedNoPhone}\n`);
