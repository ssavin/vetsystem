...
export default function MedicalRecordForm({ trigger, recordToEdit, open: controlledOpen, onOpenChange }: MedicalRecordFormProps) {
  ...
  // Only fetch doctors - no owners or patients needed with autocomplete
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] flex flex-col">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="flex-1 space-y-6 overflow-y-auto overflow-x-visible">
            {/* Basic Information */}
            <Card>
              <CardHeader>
