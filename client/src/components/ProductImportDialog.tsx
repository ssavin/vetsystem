      ...
      <DialogContent className="sm:max-w-[500px]">
        ...
        <div className="space-y-4">
          ...
          <Alert>
            ...
            <AlertDescription>
              Файл должен содержать следующие колонки: Название, Категория, Цена, Остаток, 
              Мин. остаток, Единица измерения, Описание, Артикул, НДС, Единиц в упаковке, 
              Штрихкод, Маркированный (да/нет), Тип (товар/услуга)
            </AlertDescription>
          </Alert>
