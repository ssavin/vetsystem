...
import { OwnerCardDialog } from './OwnerCardDialog'
...
export function IncomingCallNotification() {
  ...
  useEffect(() => {
    if (incomingCall) {
      ...
      // Auto-open owner card if owner is found
      if (incomingCall.owner?.id) {
        setSelectedOwnerId(incomingCall.owner.id)
  ...
  return (
    <>
      ...
      {/* Owner Card Dialog - auto-opens when call comes from known client */}
      <OwnerCardDialog 
