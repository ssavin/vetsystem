          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                ...
                onClick={(e) => {
                  e.stopPropagation()
                  console.log('📅 Registry: Click calendar for patient:', patient.id, patient.name)
                  console.log('📅 Registry: Patient owners:', patient.owners)
                  ...
                  console.log('📅 Registry: Navigating to:', url)
                  navigate(url)
                }}
